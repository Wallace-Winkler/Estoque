...
<header style="border-bottom: solid 4px yellow; background-color: #006B33;">
    ...
    <div id="php" class="col-10" style="background-color: #006B33; box-shadow: 1px 3px 26px 0px #000000; margin-top: 5%; margin-left: auto; margin-right: auto;">
   <?php
    if(isset($_POST['pesquisar'])){
       ...
       /* echo "<div class='cabeçalho'>Produto</div>";
        ...
        //$pesquisar = $_POST['pesquisar'];
        $result = mysqli_query($conectar, "SELECT * FROM produtor");
        $row = mysqli_num_rows($result);
